...
public class Trunk
{
  ...
  public void enter(Player player)
  {
    ...
    if(this.getOwnerId()==player.getAccID()||(player.get_guild()!=null&&player.get_guild().getId()==house.getGuildId()&&house.canDo(Constant.C_GNOCODE)))
    {
      ...
      SocketManager.GAME_SEND_MESSAGE(player,"his chest can only be opened by members of the guild.");
  ...
  public void addInTrunk(int guid, int qua, Player P)
  {
    ...
    {
      SocketManager.GAME_SEND_MESSAGE(P,"The maximum number of items in this chest has been reached!");
      return;
    }
