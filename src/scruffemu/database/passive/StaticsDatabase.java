package scruffemu.database.passive;

import ch.qos.logback.classic.Level;
import ch.qos.logback.classic.Logger;
import scruffemu.database.Database;
import scruffemu.database.passive.data.AccountData;
import scruffemu.database.passive.data.AreaData;
import scruffemu.database.passive.data.BanIpData;
import scruffemu.database.passive.data.CommandData;
import scruffemu.database.passive.data.GroupData;
import scruffemu.database.passive.data.GuildData;
import scruffemu.database.passive.data.HouseData;
import scruffemu.database.passive.data.MountData;
import scruffemu.database.passive.data.MountParkData;
import scruffemu.database.passive.data.ObjectData;
import scruffemu.database.passive.data.ObvejivanData;
import scruffemu.database.passive.data.PetData;
import scruffemu.database.passive.data.PlayerData;
