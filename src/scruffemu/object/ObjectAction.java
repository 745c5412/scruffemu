      ...
      for(String type : this.type.split(";"))
      {
        ...
        switch(Integer.parseInt(type))
        {
          ...
          case 13://Apprendre une �mote.
            ...
            {
              SocketManager.GAME_SEND_MESSAGE(player,"You already know this emote.");
              return;
            }
          ...
          case 22://Poser un prisme.
            ...
            {
              SocketManager.GAME_SEND_MESSAGE(player,"You do not have the necessary alignment to place a prism.");
              return;
            }
            if(!player.is_showWings())
            {
              SocketManager.GAME_SEND_MESSAGE(player,"Your wings have to be activated before placing a prism.");
              return;
            }
            ...
            {
              SocketManager.GAME_SEND_MESSAGE(player,"You can not place a prism on this map.");
              return;
            }
          ...
          case 34://Fm cac
            ...
            if(gameObject==null)
            {
              player.sendMessage("You are not wearing a weapon.");
              isOk=false;
              send=false;
              return;
            }
