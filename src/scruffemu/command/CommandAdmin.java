...
import scruffemu.command.administration.Command;
...
public class CommandAdmin extends AdminUser
{
  ...
  public void command(String command, String[] infos, String msg)
  {
    ...
    {
      Config.getInstance().debugMode=!Config.getInstance().debugMode;
    ...
    else if(command.equalsIgnoreCase("DELJOB"))
    {
      ...
      Database.getStatics().getPlayerData().update(perso);
      SocketManager.GAME_SEND_MESSAGE(perso,"You have just unlearned a profession, please reconnect to finalize the changes.");
    ...
    else if(command.equalsIgnoreCase("INFOS"))
    {
      ...
      String message="\n<u><b>Global informations system of the ScruffEmu emulator :</b></u>\n\n<u>Uptime :</u> "+day+"j "+hour+"h "+min+"m "+sec+"s.\n";
