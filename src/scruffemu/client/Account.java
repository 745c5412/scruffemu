...
public class Account
{
  ...
  public Account(int guid, String name, String pseudo, String answer, boolean banned, String lastIp, String lastConnectionDate, String friends, String enemy, int points, long subscriber, long muteTime, String mutePseudo, String lastVoteIP, String heureVote)
  {
    this.id=guid;
    this.name=name;
    this.pseudo=pseudo;
  ...
  public void addFriend(int id)
  {
    ...
    if(account==null)
    {
      SocketManager.GAME_SEND_MESSAGE(this.currentPlayer,"This account does not exist.");
      return;
    }
    ...
    if(player==null)
    {
      SocketManager.GAME_SEND_MESSAGE(this.currentPlayer,"This player does not exist.");
      return;
    }
    ...
    {
      SocketManager.GAME_SEND_MESSAGE(this.currentPlayer,"You can not add a staff member as a friend.");
      return;
    }
  ...
  public boolean recoverItem(int lineId)
  {
    ...
    if(this.currentPlayer.getWorldMarket())
      ...
      hdvID=Math.abs((Integer)this.currentPlayer.getExchangeAction().getValue());//R�cup�re l'ID de l'HDV
    ...
    try
    {
      ...
      {//Boucle dans la liste d'entry de l'HDV pour trouver un entry avec le meme cheapestID que sp�cifi�
  ...
  public void disconnect(Player player)
  {
    if(player.isLeader)
    {
      for(int i=0;i<player.followers.size();i++)
      {
        ...
        SocketManager.GAME_SEND_MESSAGE(player.followers.get(i),"The player you were following has disconnected from the game. You are no longer following anybody.");
      }
    ...
    {
      SocketManager.GAME_SEND_MESSAGE(player.leader,"A person that was following you has disconnected.");
