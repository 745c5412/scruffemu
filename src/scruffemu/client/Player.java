...
import scruffemu.client.other.Restriction;
...
public class Player
{
  ...
  public boolean learnSpell(int spellID, int level, boolean save, boolean send, boolean learn)
  {
    ...
    {
      SocketManager.GAME_SEND_MESSAGE(this,"You already know this spell.");
      return false;
    }
    else
    {
  ...
  public void teleportLaby(short newMapID, int newCellID)
  {
    ...
    if(this.getMount()!=null)
    {
      ...
      {
        this.toogleOnMount();
        SocketManager.GAME_SEND_MESSAGE(this,"Your can no longer ride your mount, it's exhausted... Feed it or let it rest in a paddock.");
      }
    }
  ...
  public void toggleWings(char c)
  {
    ...
    switch(c)
    {
      ...
      case '-':
        ...
        {
          SocketManager.GAME_SEND_MESSAGE(this,"You can not disable your wings on a heroic server.");
          break;
        }
        else
        {
  ...
  public void usePrisme(String packet)
  {
    ...
    if(kamas<costo)
    {
      SocketManager.GAME_SEND_MESSAGE(this,"You do not have enough Kamas to perform this action.");
      return;
    }
    kamas-=costo;
    SocketManager.GAME_SEND_STATS_PACKET(this);
