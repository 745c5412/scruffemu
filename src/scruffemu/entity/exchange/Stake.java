package scruffemu.entity.exchange;
...
public class Stake
{
  ...
  public synchronized void apply()
  {
    ...
    for(Pair<Integer, Integer> couple : items1) // Les items du player vers le player2
    {
      ...
      {
        SocketManager.GAME_SEND_MESSAGE(player1,"Error: a player tried to trade an item they do not own.");
        SocketManager.GAME_SEND_MESSAGE(player2,"Error: a player tried to trade an item they do not own.");
    ...
    {
      SocketManager.GAME_SEND_MESSAGE(player1,"You must be on the same map to do a stake.");
      SocketManager.GAME_SEND_MESSAGE(player2,"You must be on the same map to do a stake.");
      SocketManager.GAME_SEND_EV_PACKET(player1.getGameClient());
      SocketManager.GAME_SEND_EV_PACKET(player2.getGameClient());
      this.player1.setExchangeAction(null);
      this.player2.setExchangeAction(null);
    ...
    {
      SocketManager.GAME_SEND_MESSAGE(player1,"You can not stake on this map because it does not have fighting positions.");
      SocketManager.GAME_SEND_MESSAGE(player2,"You can not stake on this map because it does not have fighting positions.");
      SocketManager.GAME_SEND_EV_PACKET(player1.getGameClient());
      SocketManager.GAME_SEND_EV_PACKET(player2.getGameClient());
      this.player1.setExchangeAction(null);
      this.player2.setExchangeAction(null);
