  ...
  public static void getReward(Player player, int type)
  {
    ...
    switch(type)
    {
      case 1: //Sort sp�cial
        ...
        {
          SocketManager.GAME_SEND_MESSAGE(player,"You are not in your class' temple.");
          return;
        } else if(player.hasSpell(Constant.getSpecialSpellByClasse(player.getClasse()))) // Si on a d�j� le sort
        {
          SocketManager.GAME_SEND_MESSAGE(player,"You have already learned the spell.");
          return;
        }
      ...
      case 2://Trousseau de cl�s
        ...
        {
          SocketManager.GAME_SEND_MESSAGE(player,"You already have the bunch of keys.");
          return;
        }
      ...
      case 4://Reset caract�ristiques
        ...
        {
          SocketManager.GAME_SEND_MESSAGE(player,"You can not reset your stats multiple times.");
          return;
        }
